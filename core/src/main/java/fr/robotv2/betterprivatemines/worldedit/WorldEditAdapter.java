package fr.robotv2.betterprivatemines.worldedit;
...
public abstract class WorldEditAdapter {
    ...
    public abstract void pasteSchematic(MineSchematic mineSchematic, Location location, CompletableFuture<BoundingBox> future);
}
